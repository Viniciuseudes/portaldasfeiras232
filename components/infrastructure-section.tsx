...
export function InfrastructureSection() {
  return (
    <section className="relative bg-primary py-20 lg:py-32 overflow-hidden">
      <DecorativeShapes variant="light" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <h3 className="text-3xl lg:text-4xl font-bold mb-12 text-secondary">Esteja entre os pioneiros!</h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
              <div className="bg-primary-dark text-secondary px-6 py-4 rounded-2xl font-bold text-lg">
                + de 500 boxes
              </div>
              <div className="bg-accent text-white px-6 py-4 rounded-2xl font-bold text-lg">+ de 40 lojas</div>
              <div className="bg-yellow text-primary px-6 py-4 rounded-2xl font-bold text-lg sm:col-span-2">
                + praça de alimentação completa
              </div>
              <div className="bg-secondary text-primary px-6 py-4 rounded-2xl font-bold text-lg sm:col-span-2">
